...
doro-boom-selector|CSS selector for HTML elements that may explode on collison|.boom, input, textarea, select, button, a, hr, label, td, pre, h1, h2, h3, h4, h5, h6, li
...
doro-encounter-chance|Probability of encountering a doro|1
doro-random-location-chance|Probablity of doro appearing on a random location when initialized|0
doro-frenzy-chance|Probablity of doro appearing on a frenzied state when initialized|0
doro-random-doro-chance|Probability of a random alternate doro appearing|0.1
doro-random-doro-config|Comma delimited image names for the alternate random Doro heads that may appear if 'random-head-chance' is greater than 0|
doro-skin-color|Skin color of doro's body|#fff
doro-initial-animation|Animation displayed when the page is loaed (animation options: idle, dash, frenzy, fat, cow)|idle
doro-dash-animation|Animation displayed when moving around |dash
doro-stop-animation|Animation displayed when stopping due to user click|frenzy
doro-respawn-animation|Animation displayed when respawning a destroyed doro|fat
